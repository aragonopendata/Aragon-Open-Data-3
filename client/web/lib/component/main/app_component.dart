...
import 'package:aod3/service/lang_service.dart';

@Component(
    selector: 'my-app',
    templateUrl: 'app.html',
    directives: const [HeaderComponent, HomeComponent, FooterComponent, ROUTER_DIRECTIVES],
    providers: const [ROUTER_PROVIDERS, lang_service])
